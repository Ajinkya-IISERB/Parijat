...
rnaseqMatrix = read.table("NO_PRL.gene.TPM.not_cross_norm", header=T, row.names=1, com='', check.names=F)
...
write.table(exp_study$samples, file="NO_PRL.gene.TPM.not_cross_norm.TMM_info.txt", quote=F, sep="\t", row.names=F)
